...
def pnf404(request):
    return render(request,"404.html",{'site_info_data':site_info_data,'product_meta_data':meta_data()})
...
def emptyBlog(request):
    return render(request,"empty-blog-search.html",{'site_info_data':site_info_data,'product_meta_data':meta_data()})
